...
const file_exchange_proto_rawDesc = "" +
	...
	"\x1aGetExchangeRateForCurrency\x12\x19.exchange.CurrencyRequest\x1a\x1e.exchange.ExchangeRateResponseB'Z%github.com/flastors/gw-exchange-protob\x06proto3"
